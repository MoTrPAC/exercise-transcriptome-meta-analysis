        ...
        <div className="container">
          <div className="row text-left">
            ...
            <p className="text-muted">
              ...
              ), N: sample size, Type: exercise type, endur for endurance and resist for resistance exercise, Age: mean age in cohort, %M: percent of males in cohort, Time: the time window in hours. Note that a cohort can have multiple rows with the same time window and different fold changes (e.g., if a study measured the transcription at both 2h and 4h then both time points will be assigned to the 2-5h window).
            </p>
          </div>
        </div>
      </section>
